...
const { createRestaurant, getAllRestaurants, getRestaurantById,createRestaurantWithItems, getAllStatisticsResto, updateRestaurant, deleteRestaurant, acceptRestaurant, getRestaurants} = require("../controllers/restaurantController");
...
router.get("/all", authMiddleware, isAdmin, getRestaurants);
...
router.post("/accept", authMiddleware, isAdmin, acceptRestaurant);
